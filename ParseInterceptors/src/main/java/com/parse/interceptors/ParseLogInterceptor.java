 ...
 * logger.
 */
public final class ParseLogInterceptor implements ParseNetworkInterceptor {

  private final static String TAG = "ParseLogInterceptor";
  ...
  public static abstract class Logger {
    ...
    /**
     * Creates a {@code Logger}, initialize the inner lock {@code Logger} uses.
     */
    public Logger() {
    ...
    /**
     * Writes the given string through {@code Logger}.
     * @param str
    ...
    /**
     * Locks the {@code Logger}. Since multiple threads may use a same {@code Logger}, we need to
    ...
    /**
     * Writes a key-value pair through {@code Logger}. The name and value are separated by :.
     * @param name
    ...
    /**
     * Writes the given string followed by a newline through {@code Logger}.
     * @param str
     *          The string to be written.
     */
    ...
    /**
     * Writes a key-value pair followed by a newline through {@code Logger}. The name and value are
     * separated by :.
     * @param name
     *          The key of the key-value pair to be written.
     * @param value
  ...
  private static class LogcatLogger extends Logger {
    ...
    /**
     * Writes the given string to Android logcat followed by a newline. Since Android {@link Log}
  ...
  private static class ProxyInputStream extends InputStream {
    ...
    public ProxyInputStream(
      ...
      try {
        ...
        IOUtils.closeQuietly(tempProxyOutput);
        IOUtils.closeQuietly(tempProxyInput);
        throw e;
      }
  ...
  private interface InterceptCallback {
  ...
  /**
   * Intercepts the {@link ParseHttpRequest} and {@link ParseHttpResponse}.
   * @param chain
      ...
      newResponseBodyStream = new ProxyInputStream(response.getContent(), new InterceptCallback() {
        ...
        public void done(InputStream proxyInput, IOException e) {
          try {
            ...
            IOUtils.copyLarge(decompressedInput, decompressedOutput);
            ...
            IOUtils.closeQuietly(decompressedInput);
